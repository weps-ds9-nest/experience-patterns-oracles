# Designing A Better Email Preference Center

## Designing a Better Email Preference Center

Ted Goas·8 min read·Oct 18, 2017

Clean article found smry-fast Reading stack medium.com · 1,342 words

The article is ready without leaving the reader. Source: Direct extraction.

_Lessons and insights from redesigning Stack Overflow’s email preferences._

Hi. I’m [Ted](https://twitter.com/TedGoas) and I’m on the Product Design team at [Stack Overflow](https://stackoverflow.com/), a place where developers can get answers to their programming questions, find a job, and build communities around similar interests. Like many other websites, Stack Overflow sends email. Earlier this year, we set out to explore how we could improve our email experience. We’d love to share what we learned in the process.
...
2.   **Be clear** about what’s possible.
3.   **Be quick** in removing roadblocks and honoring users’ wishes.
...
> _One of my biggest apprehensions is annoying our community. Worrying about that keeps me up at night. —_[Nick Craver](https://stackoverflow.blog/2016/11/how-we-make-money-at-stack-overflow-2016-edition/)
...
And when we _do_ email you, we tell you why. Every email includes _a reason_ you got email. We watched our language and made sure our internal speak didn’t end up in the text (such as “Profile merge expired,” “Active status decayed,” and other glorious names we give emails at Stack Overflow).
...
This is where I mark emails as spam.

> _There is nothing worse than making the user do more than completely necessary when it comes to trying to remove themselves from communications.-_[Becs Rivett-Kemm](https://medium.com/@Conversio/sorting-out-our-email-marketing-opt-ins-223ca92483e7#.awwrvphxz)
...
Our email preferences redesign
...
This article shows how we applied our design principles to the design of Stack Overflow’s email preference center. [Donna Choi wrote about how we designed the UX behind unified email management for Stack Overflow’s 150+ site network](https://medium.com/stack-overflow-design/stack-overflow-email-management-a-ux-case-study-964784da541b).

_Thanks to_[_Donna_](https://twitter.com/donna_says)_and_[_Kristina_](https://twitter.com/kristinalustig)_for their help with this article.

 Also posted at_[http://www.tedgoas.com/blog/email-preferences-design](http://www.tedgoas.com/blog/email-preferences-design)
