...
And when you’re designing for action, buttons should be your first choice. That’s what they’re built for—and it’s what users expect. Following user expectations and [established UI patterns](https://balsamiq.com/learn/learning-tracks/intro-to-ui-design/ui-design-patterns/) is the most reliable way to create effective, user-centered products.
...
## [](https://balsamiq.com/learn/articles/button-design-best-practices/#button-structure-amp-hierarchy-is-everything)Button structure & hierarchy is everything
...
Your button design should clearly communicate, _“Hey, you can click me!”_ And thankfully, you don’t need anything fancy to get there. A few [foundational design principles](https://balsamiq.com/learn/learning-tracks/intro-to-ui-design/visual-design-principles/)—like [hierarchy](https://balsamiq.com/learn/learning-tracks/intro-to-ui-design/visual-design-principles/#hierarchy), color, shape, and [contrast](https://balsamiq.com/learn/learning-tracks/intro-to-ui-design/visual-design-principles/#contrast)—can do most of the work.
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#1-make-buttons-look-like-buttons)1. Make buttons look like buttons

Users already know what a [button](https://balsamiq.com/learn/buttons/) looks like. You don’t need to reinvent it. In fact, you _shouldn’t_.
...
![Image 1: Button design best practices](https://balsamiq.com/assets/learn/articles/Buttons-that-look-like-buttons.png)

Buttons that look like buttons (left) vs. buttons that don't (right)

### [](https://balsamiq.com/learn/articles/button-design-best-practices/#2-primary-and-secondary-buttons-should-look-different)2. Primary and secondary buttons should look different

In any given interface, one action should stand out as the _next best step_. That’s your **primary button**. It could be “Sign Up,” “Save Changes,” or “Get Started.” Whatever it is, it deserves visual priority.
...
![Image 2: Primary and secondary buttons example](https://balsamiq.com/assets/learn/articles/buttons-gusto-example.jpg)
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#3-buttons-are-not-links)3. Buttons are not links

[Buttons and links](https://balsamiq.com/blog/buttons-links/) are not interchangeable—and treating them like they are is a fast way to confuse your users.

**Buttons** initiate actions: submitting a form, starting a process, opening a [modal](https://balsamiq.com/learn/popups-modals-lightboxes/).

**Links** are for [navigation](https://balsamiq.com/learn/learning-tracks/how-to-design-navigation/): jumping to another page or section.

Styling them the same way leads to hesitation or misclicks. Users shouldn’t have to pause and wonder: _“Is this going to take me somewhere or do something?”_
...
![Image 3: How to use button and links together](https://balsamiq.com/assets/learn/articles/button-link-difference.jpg)
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#4-don-t-have-more-than-one-primary-action-button-on-the-screen-at-a-time)4. Don’t have more than one primary action button on the screen at a time
...
![Image 4: Cancellation page button design example](https://balsamiq.com/assets/learn/articles/Audible-cancel-account.jpg)
...
## [](https://balsamiq.com/learn/articles/button-design-best-practices/#button-placement-should-feel-natural)Button placement should feel natural
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#5-place-primary-actions-where-users-finish-their-task)5. Place primary actions where users finish their task
...
![Image 5: Button design placement example](https://balsamiq.com/assets/learn/articles/Button-placement-1.png)

Button design placement left vs right example

Look at this scanning pattern, which do you think is easiest?

![Image 6: User scanning patterns](https://balsamiq.com/assets/learn/articles/Button-placement-2.png)

How your users will scan information

### [](https://balsamiq.com/learn/articles/button-design-best-practices/#6-avoid-floating-or-disconnected-buttons)6. Avoid floating or disconnected buttons
...
![Image 7: Floating button design](https://balsamiq.com/assets/learn/articles/Button-placement-3.png)
...
**Related Article:**[SaaS website design: Lessons from real users](https://balsamiq.com/blog/saas-website-design-lessons/)

## [](https://balsamiq.com/learn/articles/button-design-best-practices/#button-wording-needs-to-build-confidence)Button wording needs to build confidence
...
While you don’t need final content, thinking through [wireframe website copy](https://balsamiq.com/blog/wireframing-website-copy-why/)—especially button text—early on helps map out a stronger user experience.

Let’s walk through how to write button copy that’s clear, helpful, and user-friendly.

### [](https://balsamiq.com/learn/articles/button-design-best-practices/#7-keep-it-short-and-specific)7. Keep it short (and specific)
...
![Image 8: Concise button copy](https://balsamiq.com/assets/learn/articles/buttons-concise-example.jpg)
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#8-say-exactly-what-happens-next)8. Say exactly what happens next
...
Instead, use action-oriented language that sets the right expectation. If your button label could work on _any_ page of your site, it’s probably too generic.
...
![Image 9: Button flow design](https://balsamiq.com/assets/learn/articles/Dropbox-Create-File.png)

Create New File UX from dropbox.com

### [](https://balsamiq.com/learn/articles/button-design-best-practices/#9-match-the-button-to-the-moment)9. Match the button to the moment

Your primary button should align with what the user is doing right now—not what _you_ think comes next in your flow.
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#10-avoid-words-that-can-potentially-cause-confusion)10. Avoid words that can potentially cause confusion
...
At [Balsamiq](https://balsamiq.com/), deleting one of your projects is a huge deal. We make users take the extra step of writing the word DELETE to ensure they really want to delete a project. This allows users extra time to think through their actions and avoid mistakes.

![Image 10: Destructive button design](https://balsamiq.com/assets/learn/articles/delete-project-balsamiq.jpg)
...
![Image 11: Button design for undo action](https://balsamiq.com/assets/learn/articles/undo-delete.jpg)

Users still have a way to undo their action

### [](https://balsamiq.com/learn/articles/button-design-best-practices/#11-speak-the-user-s-language-not-yours)11. Speak the user’s language, not yours
...
## [](https://balsamiq.com/learn/articles/button-design-best-practices/#button-size-amp-spacing-matters)Button size & spacing matters

You’ve nailed the look. The label is clear. But is your button easy to **actually click**—especially on mobile?

Button size and spacing play [a huge role in usability](https://balsamiq.com/blog/heuristics/). Too small? Users will miss it or mis-tap. Too close together? They’ll hit the wrong one. Give your buttons the space they need to feel touch-friendly, intentional, and frustration-free.

### [](https://balsamiq.com/learn/articles/button-design-best-practices/#12-design-for-fingers-not-cursors)12. Design for fingers, not cursors
...
![Image 12: Ideal button sizes and tap areas](https://balsamiq.com/assets/learn/articles/button-sizing.jpg)
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#13-use-padding-to-create-comfortable-tap-zones)13. Use padding to create comfortable tap zones

It’s not just the button size—it’s the space _around_ it that matters, too.
...
## [](https://balsamiq.com/learn/articles/button-design-best-practices/#button-color-isn-t-just-about-looks)Button color isn’t just about looks
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#14-give-color-meaning)14. Give color meaning
...
![Image 13: Button color best practices](https://balsamiq.com/assets/learn/articles/buttons-colors-examples.jpg)
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#15-use-contrast-to-make-buttons-stand-out)15. Use contrast to make buttons stand out
...
## [](https://balsamiq.com/learn/articles/button-design-best-practices/#button-consistency-is-key)Button consistency is key

When buttons look and behave the same across your pages, users don’t have to stop and think—they just _know_ what to do.

Consistency isn’t just a nice-to-have, it’s one of the most important [principles of effective wireframes](https://balsamiq.com/blog/ten-principles-effective-wireframes/).
...
### [](https://balsamiq.com/learn/articles/button-design-best-practices/#16-keep-the-same-styles-across-screens-and-flows)16. Keep the same styles across screens and flows
...
![Image 14: Button design consistency](https://balsamiq.com/assets/learn/articles/buttons-inconsistencies.jpg)

Different button shapes are just confusing

### [](https://balsamiq.com/learn/articles/button-design-best-practices/#17-avoid-styling-buttons-differently-just-because)17. Avoid styling buttons differently “just because”
...
When in doubt, reuse what already exists. Your [design system](https://balsamiq.com/blog/wireframes-design-systems/) (or even a shared Balsamiq wireframe) can help make that decision easier.

Good design systems are made of reusable parts, not one-off choices.

## [](https://balsamiq.com/learn/articles/button-design-best-practices/#better-buttons-better-experiences)Better buttons, better Experiences
...
Whether you’re designing a sign-up [form](https://balsamiq.com/blog/form-design-best-practices/), an [e-commerce checkout](https://balsamiq.com/blog/e-commerce-design-best-practices/#cart-design), or a simple settings panel, thoughtful button design makes the difference between “I think this is right…” and “Let’s go.”

A good button isn’t just a design element—it’s a moment of clarity.

🎓 Want to dive deeper into how design influences behavior? Check out our course on [The Psychology of UI Design](https://balsamiq.com/learn/learning-tracks/ui-design-psychology/).

### [](https://balsamiq.com/learn/articles/button-design-best-practices/#designing-buttons-just-got-a-lot-easier)Designing buttons just got a lot easier

[Try Balsamiq Cloud free for 14 days](https://balsamiq.com/product/). Map out your screens, test button placement and wording early, and give your team a clear direction—before a single line of code. It’s the fastest way to build interfaces that feel intuitive from the first click.

## [](https://balsamiq.com/learn/articles/button-design-best-practices/#faqs)FAQs

 What are the best practices for button hierarchy? 
Use visual cues like size, color, and placement to make the primary button stand out. Secondary and tertiary buttons should be more subtle, using lighter colors or outlines to signal lower priority without distracting users from the main task.

 What is a key principle for designing effective buttons? 
Clarity is key. Users should instantly understand what a button does—whether it's submitting a form, starting a download, or moving to the next step. Use clear labels, strong visual contrast, and familiar placement to make buttons feel intuitive.

 How many buttons is too many for one screen? 
There's no clear-cut answer, but if users have to stop and think about which button to press (or tap), you've probably got too many. Stick to one primary action per screen, and group other related options to prevent decision fatigue.

 What makes a button look clickable or tappable? 
A user will interact with a button when it stands out from its surrounding elements. A good button will also follow patterns, like having a distinct shape, label, and hover state. Adding subtle shadows, borders, or color contrast is another way to make a button feel interactive.

 Should all buttons be the same size? 
Not necessarily. Primary actions should stand out, while secondary or tertiary buttons can be smaller or less prominent. Just make sure they're still easy to click or tap, especially on mobile.
