# Posted 16th February 2023 in [Accessibility](https://www.tempertemper.net/category/accessibility) and[Design](https://www.tempertemper.net/category/design)

Posted 16th February 2023 in [Accessibility](https://www.tempertemper.net/category/accessibility) and[Design](https://www.tempertemper.net/category/design)

I’ve written about what to do when [links need to look like buttons](https://www.tempertemper.net/blog/when-design-breaks-semantics) and [buttons need to look like links](https://www.tempertemper.net/blog/if-you-need-a-link-dont-use-a-button), but it’s sometimes tricky to know whether an element should be a button or a link in the first place.
...
Following a link will take your focus and drop it at the very start of a new page, but what about links to a part of the _same page_?
...
Admittedly, it gets a bit complicated if the button you pressed to open the modal is not there any more. Here’s an example: you press a button to remove an item from a list, and a modal pops up to ask you if you are sure you want to do this; if you confirm you _are_ happy to proceed the list item, and therefore button you pressed won’t be there when the modal is closed.
...
[I don’t collect any data](https://www.tempertemper.net/privacy-policy#newsletter) on when, where or if people open the emails I send them. Your email will only be used to send you newsletters and will never be passed on. You can [unsubscribe](https://www.tempertemper.net/newsletter/unsubscribe) at any time.

## More posts

Here are a couple more posts for you to enjoy. If that’s not enough, have a look at [the full list](https://www.tempertemper.net/blog/).

1.   ### [When design breaks semantics](https://www.tempertemper.net/blog/when-design-breaks-semantics)
...
2.   ### [Do it properly now](https://www.tempertemper.net/blog/do-it-properly-now)
