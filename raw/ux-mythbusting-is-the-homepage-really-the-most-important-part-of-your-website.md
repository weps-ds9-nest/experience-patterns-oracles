Title: UX Mythbusting: Is The Homepage Really The Most Important Part of Your Website?

URL Source: https://blog.adobe.com/en/publish/2017/11/23/ux-mythbusting-is-the-homepage-really-the-most-important-part-of-your-website

Markdown Content:
![Image 1: Nick Babich](https://blog.adobe.com/en/publish/2017/11/23/media_1e8be6e5e758b4ed8efc77a9aa7a1f0fbf0dcde59.png?width=750&format=png&optimize=medium)

![Image 2](https://blog.adobe.com/en/publish/2017/11/23/media_18d7aeaaafe914407e65d67f4f2a1c5ef3e1a2980.jpg?width=750&format=jpg&optimize=medium)

Adobe Stock / vectorfusionart

The homepage is the page that often gets the most attention from design teams. A lot of time and effort is spent on perfecting both its visual design and content — much more than for any other page on the website.

But is the homepage really _that_ important? There was a time, not too long ago, when a company’s homepage was considered the key part of its website. This is no longer the case. In fact, it might actually be the _least_ important page on the site.
...
*   _The homepage creates the first impression._
*   The homepage gets the most views, so it’s the most important page on a website.
...
While the homepage might be the most viewed page on your website, that doesn’t automatically mean you should spend all your time on its optimization. There’s one crucial reason for this — _the homepage is just a step in the user journey, it’s not a final destination for users._ The role of a homepage in a user’s journey is similar to a hotel lobby. The lobby is an essential part of every hotel but not the place visitors want to say. People don’t come to a hotel to stay in the lobby — they want to stay in a room. Similarly, most of the time people spend on websites is not on the homepage.

Joshua Porter focused on this in his article [Prioritizing Design Time: A Long Tail Approach](https://articles.uie.com/prioritizing_design_time/). He analysed [uie.com](https://www.uie.com/)’s visitor statistics and found that while the homepage had more views than any other page on the site, it wasn’t the most valuable part of the website. Lower level articles are what actually bring value for users, so optimizing these pages makes more sense than optimizing the homepage.

## How people use homepages.

Understanding how people use homepages is critical for creating a proper homepage design. In studying user behavior, [Jared Spool’s team](https://www.uie.com/brainsparks/2005/09/29/is-home-page-design-relevant-anymore/) figured out that the homepage provides just two functions that are really important for users:
...
![Image 4](https://blog.adobe.com/en/publish/2017/11/23/media_143e3101f95276b59943af6e75052a839c1560869.jpg?width=750&format=jpg&optimize=medium)
...
One good example of a goal-driven homepage design is [Airbnb](https://www.airbnb.com/). The page doesn’t overwhelm users with information, but provides just enough details so users can start the journey of booking a place to stay.

![Image 5](https://blog.adobe.com/en/publish/2017/11/23/media_13f74041d77f1b8dc63d98110e2a6d9b7ad73e9ba.jpg?width=750&format=jpg&optimize=medium)
...
Interestingly enough, the homepage’s ability to achieve a website’s primary goal is more important than its visual attractiveness. One good example of that is [Craigslist](https://provo.craigslist.org/). The homepage for Craigslist contains a search box and a list of categories. This page itself doesn’t bring any value for visitors and looks dated. But most users don’t care about that — as soon as they get to the particular category they’re looking for, the site becomes valuable for them.

![Image 6](https://blog.adobe.com/en/publish/2017/11/23/media_1f5b14c311d93390567d83fa23549a4a8eff8aac9.jpg?width=750&format=jpg&optimize=medium)
...
As mentioned, a lot of traffic bypasses a site’s homepage and goes directly to its content pages. It’s worth investigating _where_ users spend their time. Use tools like Google [Analytics](https://www.adobe.com/experience-cloud/glossary/analytics.html) to understand a current user’s behavior — look at total numbers of pageviews but also at time spent on each page across each page type (e.g. articles, the ‘About Us’ page, the product detail page). This will make it clear what content is the most interesting for your users. After that, you’ll be able to optimize your homepage to provide a short route to that content.

#### Embrace simplicity.

Most users define an ideal web experience as being able to find what they’re looking for quickly. To satisfy that, keep the “[less is more](https://blogs.adobe.com/creativecloud/functional-minimalism-for-web-design/)” principle in mind and avoid cluttering your homepage with excessive text, images, and videos. Remove all the unnecessary distractions and focus on a simple design that is relevant for users.

![Image 7](https://blog.adobe.com/en/publish/2017/11/23/media_1efbab2cd71d5f413a00a09f0392356e7148fa5b1.jpg?width=750&format=jpg&optimize=medium)
