...
URL Source: https://smry.ai/https:/medium.com/design-led/case-study-designing-dashboards-3c649136a563
...
So when you’re designing a new product, it’s hard to elevate your work to become screen-grab-ready (I think this has driven the trend to more illustrations and [block-frames](https://medium.com/ux-power-tools/tiny-trend-6-blockframe-heroes-cc7428fcdef9) in product marketing sites).
...
IKEA is Swedish for SHÖRÜÜMMĖ (unverified)
...
ScreenGrab of the Sample Excel Sheet
...
Rough work: Shows the relationship research on the left and a sample dashboard layout on the right.

With the relationship established and a rough wireframe for the same, I picked up the UI of the Dashboard, keeping it while [choosing the best possible graphs](https://medium.com/@DP6/how-to-choose-better-charts-for-my-data-dataviz-basics-2-of-4-e99ea32aa7a1) to display the information.
