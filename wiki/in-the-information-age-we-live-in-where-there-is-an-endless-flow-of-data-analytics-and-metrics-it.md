...
*   **Data visualization**: There are various ways to visually represent information: graphs, diagrams, tables, heat maps, [affinity maps](https://uxtbe.medium.com/ux-affinity-maps-b84ec13a77f7), radar or spider charts…
*   **Action components**: Tools provided to users to customize or distribute the information according to their needs, such as zoom buttons, [filter systems](https://medium.com/@uxtbe/filter-systems-and-ux-1b79abe3b9a5), comparison buttons, export or edit options, different visualization types for the same data flow…
...
## [Dashboards: recomendaciones UX a la hora de crear páginas de datos | Torresburriel Estudio](https://torresburriel.com/weblog/dashboards-recomendaciones-ux/?source=post_page-----98d8bb86c438---------------------------------------)

### [Optimiza la toma de decisiones con dashboards diseñados para claridad y funcionalidad, facilitando la gestión eficaz de… torresburriel.com](https://torresburriel.com/weblog/dashboards-recomendaciones-ux/?source=post_page-----98d8bb86c438---------------------------------------)
