Title: LukeW | Pinball User Interface

URL Source: https://www.lukew.com/ff/entry.asp?2059?ref=heydesigner

Markdown Content:
Using software can be hard. All those form fields, menu items, interactive widgets and more... [continually changing](https://www.lukew.com/ff/entry.asp?2049). So why make it harder for people by strewing all these user interface elements around a screen? This happens enough in applications that it needs a name. So let's call it **Pinball UI**.

Pinball UI happens when the various user interface elements on an application screen could be arranged meaningfully... but are not. An intentional layout of user interface elements can help people make their way through a process (like filling in a form) or make the relationships between various bits of content and actions clear. Designers use [visual relationships](https://www.lukew.com/presos/preso.asp?16) to make these functional relationships clear to users. In Pinball UI, they do not.
...
[![Image 1: PayPal payment form pinball layout](https://static.lukew.com/pinball_ui_paylpal_before.png)](https://static.lukew.com/pinball_ui_paylpal_before.png)
...
[![Image 2: PayPal payment form clear path to completion layout](https://static.lukew.com/pinball_ui_paylpal_after.png)](https://static.lukew.com/pinball_ui_paylpal_after.png)

This example from PayPal was featured in my 2008 book, [Web Form Design](https://www.lukew.com/resources/web_form_design.asp), alongside user research and eye-tracking data highlighting why clear paths to completion reduce errors, speed up annoying processes (like filling in Web forms), and give people more confidence in their actions. So now it's 2024 and Pinball UI is a thing of the past, right?

[![Image 3: Google sign up form pinball layout](https://static.lukew.com/pinball_ui_google_before.png)](https://static.lukew.com/pinball_ui_google_before.png)
...
[![Image 4: Google sign up form clear path to completion layout](https://static.lukew.com/pinball_ui_google_after.png)](https://static.lukew.com/pinball_ui_google_after.png)
