...
![Image 1](https://www.w3.org/WAI/content-images/wai-aria-practices/images/pattern-slider.svg)
## Examples

*   [Color Viewer Slider Example](https://www.w3.org/WAI/ARIA/apg/patterns/slider/examples/slider-color-viewer/): Basic horizontal sliders that illustrate setting numeric values for a color picker.
*   [Vertical Temperature Slider Example](https://www.w3.org/WAI/ARIA/apg/patterns/slider/examples/slider-temperature/): Demonstrates using `aria-orientation` to specify vertical orientation and `aria-valuetext` to communicate unit of measure for a temperature input.
*   [Rating Slider Example](https://www.w3.org/WAI/ARIA/apg/patterns/slider/examples/slider-rating/): Horizontal slider that demonstrates using `aria-valuetext` to make it easy for assistive technology users to understand the meaning of the current value chosen on a ten-point satisfaction scale.
*   [Media Seek Slider Example](https://www.w3.org/WAI/ARIA/apg/patterns/slider/examples/slider-seek/): Horizontal slider that demonstrates using `aria-valuetext` to communicate current and maximum values of time in media to make the values easy to understand for assistive technology users by converting the total number of seconds to minutes and seconds.
