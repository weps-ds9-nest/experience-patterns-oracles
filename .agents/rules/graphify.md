# UX Pattern Oracle — Antigravity Instructions
...
- Use the project's uv dependency management: `uv sync --no-install-project`
- When running Python scripts, use: `uv run --no-project python <script>.py`
