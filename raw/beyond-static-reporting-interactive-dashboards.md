...
URL Source: https://smry.ai/https:/medium.com/gooddata-developers/beyond-static-reporting-interactive-dashboards-93705eafccac
...
Let’s have a look at a sample dashboard and explore some of its interactive features. For demonstration, I’ve selected our standard demo workspace that you can get together with the [GoodData’s trial](https://www.gooddata.com/trial/?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek). This simplifies your own experimenting.

### Cross-filtering

[Cross-filtering](https://www.gooddata.com/docs/cloud/create-dashboards/filters/#cross-filtering?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek) is a powerful feature for interactive dashboard crafting, allowing for dynamic and intuitive data exploration. It connects multiple visualizations that respond to user interactions in real time, making it easy to construct highly engaging and informative interfaces.

A demonstration of cross-filtering in action
...
[Dependent filters](https://www.gooddata.com/docs/cloud/create-dashboards/filters/dependent-filters-dashboards/?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek) play a crucial role in enhancing dashboard effectiveness by ensuring that users interact with data relevant to their context during exploration. These filters establish relationships between different selection criteria, letting users adjust their queries dynamically based on previous selections.
...
An example of dependent filters in action
...
[Drill down](https://www.gooddata.com/docs/cloud/create-dashboards/drilling-in-dashboards/set-drill-down/?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek) features let users delve into specific layers of data detail within the same visualization for a deeper understanding of trends and easy discovery of actionable insights.
...
To ensure that dashboard users drill along meaningful paths, we’ve designed our drilling capability around the idea of [attribute hierarchies](https://www.gooddata.com/docs/cloud/create-dashboards/drilling-in-dashboards/set-drill-down/#attribute-hierarchy?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek) with date hierarchies created automatically. Whether you set up a hierarchy for a specific visualization or apply it globally across all occurrences of an attribute, you can make sure the users always get relevant data.

### Drill into dashboard and drill into visualization

Last but not least, you can use [drill into visualization](https://www.gooddata.com/docs/cloud/create-dashboards/drilling-in-dashboards/set-drill-into-insight/?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek) or [drill into dashboard](https://www.gooddata.com/docs/cloud/create-dashboards/drilling-in-dashboards/set-drill-into-dashboard/?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek) features, providing a structured way to access related or additional information.
...
**We’re committed to expanding our feature set, guided by your feedback!** We recommend you regularly review our [product documentation](https://www.gooddata.com/docs/cloud/create-dashboards/?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek) to get the full overview of available interactivity options. Please share your insights and dashboard examples with us via our [community Slack channel](https://www.gooddata.com/slack/?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek).

We’re also exploring enhancements in data interactivity through smart integrations and AI-powered tools, as detailed in Tom Czaban’s piece on [leveraging AI for data visualization](https://www.gooddata.com/blog/how-to-use-ai-for-data-visualizations-and-dashboards/?utm_medium=blogpost&utm_source=medium.com&utm_campaign=beyond_static_reporting_02_2024&utm_content=autor_mirek).
