# [**Dashboard**](https://www.merriam-webster.com/dictionary/dashboard)_noun \ˈdash-ˌbȯrd\_ A screen on the front of a usually horse-drawn vehicle to intercept water, mud, or snow.
...
![Image 1: P](https://miro.medium.com/v2/resize:fit:158/1*KLIlON_4mxaoWycK9qoMSA.png) art of a digital product’s architecture is the arrangement of content in order of natural hierarchy, possibly manifested as a flow through the simplest/shortest possible path as seen from the perspective of the person using your product, ideally requiring as little preexisting knowledge as possible so they can hit their goals just by knowing what they want or need.

Dashboards are some means to that end.

> If you’ve ever tried to use something and thought, “where am I supposed to go next?” you are encountering an issue with architecture. — [IA Institute](https://www.iainstitute.org/)

Simply put, effective dashboards are layouts that make _relevant key_ information accessible, provide comparable metrics or show trends over time, and are actionable.

For this to happen, information needs to be easy to scan; through establishing prominent visual anchors.

People are (in my experience) visually-based for the most part, [colors deeply affect our initial emotional responses](https://www.nngroup.com/articles/testing-visual-design/) to the extent that hinders usability testing and may undermine prototypes in certain scenarios. We are easily distracted by [clutter](https://paw.princeton.edu/article/psychology-your-attention-please), and possibly intimidated if not cognitively overloaded by variety of options.

Gradual shifts between data, information, and actionable knowledge and how they’re perceived.

Which brings us to the first advice, adopt (drum roll)…

## Minimalism

> A good designer finds an elegant way to put everything you [want] on a page. A great designer convinces you half that shit is unnecessary. — [Mike Monteiro](https://medium.com/@monteiro)
...
This point is also closely related to the commonly overlooked principle of [Visibility of System Status](https://www.nngroup.com/articles/visibility-system-status/).
