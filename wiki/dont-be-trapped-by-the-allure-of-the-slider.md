...
Audio soundboard (Photo by Luke Southern)

Volume Slider on a MacBook Pro Touch Bar (Photo by Markus Spiske)

## What’s a slider?

Sliders in UI were inspired by physical hardware controls. Soundboards often include sliders for controlling the volume of each audio channel. The board’s user can make adjustments by moving the slider within a limited range, such as 0 to 100%. Let’s translate this idea to software. Sliders can work in a similar way for digital controls like the one on a MacBook Pro with Touch Bar. Based on the skeuomorphic reference a user can quickly decipher this control is a handle on a track. Moving the handle along the track with a touch gesture will instantly increase or decrease the volume. Simple right? Let’s look closer.
...
Slider: How many tacos? Range of Some to All of them
...
Slider: How many tacos? Range of 1, 5, 10, 15, 20.

Slider: How many tacos? with Stepper buttons
...
App design with Slider inputs for calculating mortgage combinations
...
Your take-away from this slider example is this: **special isn’t always better**. When you brainstorm design ideas you can think big, sketch creative ideas, and add visually interesting or trendy components. As you refine, don’t fall in love with your own ideas because they wont all be good ones. Always test and validate your design choices to make sure they are founded on good user experience fundamentals.
...
Read about other common UI Traps: [Disabled Buttons](https://medium.com/@jamescarleton/ui-traps-disabled-buttons-and-inputs-704d70e35bf5) and [Date Inputs](https://medium.com/@jamescarleton/ui-traps-date-input-494db6ee09a4)
